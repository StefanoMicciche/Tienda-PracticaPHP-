...
// Cargar productos de mujer
$productos = loadProducts('mujer');
?>

<div class="row mb-4">
    <div class="col-md-12">
        <h1 class="mb-3">Moda Mujer</h1>
        ...
        <div class="card bg-light">
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h4 class="mb-2">Colección Mujer</h4>
                        <p class="mb-md-0">Descubre nuestras últimas novedades en moda femenina con las mejores tendencias de la temporada.</p>
                    </div>
            ...
            <div class="col-sm-6 col-md-4 col-lg-3">
                <div class="card product-card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="producto.php?id=<?php echo $producto['id']; ?>&cat=mujer" class="btn btn-outline-primary mb-2 w-100">Ver detalles</a>
